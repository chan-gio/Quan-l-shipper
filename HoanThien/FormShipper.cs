...
namespace HoanThien
{
    public partial class FormShipper : Form
    {
        ...
        {
            OpenChildForm(new FormChildShipper.frm_TaiKhoan(), sender);
        }

        private void btn_donhang_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormChildShipper.frm_DonHang(), sender);
        }

        private void btn_vanchuyen_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormChildShipper.frm_VanChuyen(), sender);
        }

        private void btn_thongbao_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FormChildShipper.frm_ThongBao(), sender);
        }
